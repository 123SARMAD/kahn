...
return ' '.$jam.' '.$jam.'
            •?((¯°·._.• CHAMPION BOT T3AM •._.·°¯))?•
              XxxX__________ SARMAD KHAN __________XxxX
   OooooO :) SIT3 URL -_-_-_ UNLIMITED-USER .TK -_-_-_ :) OooooO 
        3:) " FOR BOT SIT3 03367447010 <3 SARMAD KHAN <3 " 3:)
'.$hr;
}
...
foreach($slout as $me){
$true=file_get_contents('kussa/'.$me);
$break=explode('*',$true);
